...
const MotorForm = () => {
  ...
  return (
    <>
      ...
      <Row>
        <InputField as={Col} controlId="formGroup" controlProps={{ type: 'text' }} label="Group" name="group" xs="6" />
        <InputField
          as={Col}
      ...
      <PositionConfigurationForm propName="neutralPosition" title="Neutral Position" />
      <PositionConfigurationForm title="Minimum Position" propName="minPosition" />
      <PositionConfigurationForm title="Maximum Position" propName="maxPosition" />
